...
All notable changes to Polenta ToDo Wallpaper are documented in this file.
...
- Desktop to-do panel with edit/save workflow
- System tray control (show/hide, About, quit)
- Customizable colors, font size, opacity, and screen-percentage window size (centered)
